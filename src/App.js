...
const particlesOptions = {
  ...
  function generateDateTime(){
    ...
    var MinTime = year + '-' + month + '-' + day + 'T' + hour + ':' + minute + ':' + lowerSeconds + '-0'+timeOffset+':00';
    var MaxTime = year + '-' + month + '-' + day + 'T' + hour + ':' + minute + ':' + uppserSeconds + '-0'+timeOffset+':00';
...
class App extends Component {
            ...
            <div>
             ...
             <Container style={{maxWidth: maxWidth}}>
                 ...
                 {console.log("this.state.contacts")}
                     {console.log(this.state.contacts)}
                     {this.state.contacts && this.state.contacts.map((contact, indx) => {
                        return (
                            <Col>
        ...
        fetch(url)
            ...
            .then((data) => {
                ...
                for (var i = 0; i < employeeArray.length; i++) {
                    ...
                    if (employeeData.status == "confirmed" && addedEmployees[employeeName] != true) {
    ...
    componentDidMount() {
        ...
        setInterval(() => { this.updateManagers(); },60000)
    }
